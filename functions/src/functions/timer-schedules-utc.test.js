...
const CLOCK_DEPENDENT = {
  ...
  // Ahead of the Tuesday 09:00 America/Chicago send slot in either DST offset;
  // schedulers.js carries the reasoning for the gap.
  buildNewsletterIssue: { schedule: '0 0 8 * * 1', utc: 'Monday 08:00' },
