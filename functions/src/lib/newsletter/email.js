 ...
 *
 * Its own module so platform-settings.js can validate a reply-to without
 * loading the signup handlers, the Resend client and the quota code at cold
 * start. handlers.js re-exports it, so there is still exactly one definition.
 */
