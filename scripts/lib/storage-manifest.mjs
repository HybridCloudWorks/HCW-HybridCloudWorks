...
export const PREFIXES = Object.freeze([
  ...
  },
  {
    ...
    note: '3 objects under hero/ and secondary1/ — images attached to public content submissions. No Site-Main storage.rules match and no reader found at 088f458; the Azure port (functions/src/lib/submissions.js) decides the path it writes. Owner decision 2026-08-21 (runbook step 10): copy.',
  },
  {
    prefix: 'designs/',
    disposition: 'migrate',
    container: 'content',
    blobPrefix: 'designs/',
    note: '1 object under a single design id — pairs with the 1-document `designs` collection. No storage.rules match at 088f458. Owner decision 2026-08-21 (runbook step 10): copy.',
  },
  {
    prefix: 'thumbnails/',
    disposition: 'skip',
    container: null,
    blobPrefix: '',
    note: 'Auto-generated thumbnails. Empty in the 2026-08-21 inventory and nothing on the Azure side reads them. Owner decision 2026-08-21 (runbook step 10): drop.',
  },
  {
    prefix: 'articles/',
    disposition: 'skip',
