...
| [0025](0025-cosmos-firewall-datacenter-sentinel) | The Cosmos datacenter-IP sentinel | Accepted; recommendation reversed by its own addendum | Weigh closing T-718 against its cost — then remove the sentinel once a cheaper route appeared |
