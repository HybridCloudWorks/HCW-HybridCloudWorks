...
[ADR 0016](0016-reversible-migration) committed this platform to a reversible
...
**3. The delta import is retired.** [Cutover Runbook](Cutover-Runbook) step 4 is
headed RETIRED with the cost stated rather than deleted, and
[Phase-4-Data-Migration](Phase-4-Data-Migration) carries the evidence row.
