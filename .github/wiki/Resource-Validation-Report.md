...
**Remaining to close the loop:** set the three Azure OIDC repository
variables (values from the `github_deploy_client_id` Terraform output +
...
*Generated by the resource validation pass, 2026-08-18. Re-run the external
layer any time via Actions → Validate Deployed Surface.*
