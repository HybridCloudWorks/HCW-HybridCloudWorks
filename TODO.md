...
| Item | Issue |
| --- | --- |
| Apply the Copilot code review MCP configuration: Terraform apply, `COPILOT_REVIEW_CLIENT_ID`, the fine-grained token, the settings paste | [#369](https://github.com/HybridCloudWorks/HCW-HybridCloudWorks/issues/369) |
