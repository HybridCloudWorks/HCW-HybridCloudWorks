...
| Purge protection | `purge_protection_enabled` stays **`false`** by an owner decision of 2026-08-24 — it is a one-way switch that removes the teardown-and-recreate path a single-environment estate depends on. Soft delete at 90 days is the compensating control | `TODO.md` *Accepted risks*, [ADR 0021](../decisions/0021-key-vault-purge-protection.md) |
