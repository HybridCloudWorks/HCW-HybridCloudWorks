...
| Alerting | Five metric and log rules routed through `ag-plat-prod-cus-01` — **declared, not yet applied**; the live estate has none. What each one means, what to check first, and what nothing watches | [Alerting and support](../runbooks/alerting-and-support.md), `infra/observability.tf` |
