...
The 2026-08-18 resource validation pass ([Resource-Validation-Report](../architecture/resource-validation-report.md))
...
| --- | --- |
| One Function App instead of the API/worker/labs split | [ADR 0019](../decisions/0019-single-function-app.md) (supersedes ADR 0004) |
| Flat native `azurerm` root module instead of AVM composition | [ADR 0020](../decisions/0020-native-terraform-root-module.md) (supersedes ADR 0005's module clause) |
...
- Supersedes plan v0.1; amends [ADR 0011](../decisions/0011-single-region-recovery.md), [ADR 0013](../decisions/0013-ai-provider-strategy.md), [ADR 0014](../decisions/0014-storage-and-media.md)
- [ADR 0019](../decisions/0019-single-function-app.md) · [ADR 0020](../decisions/0020-native-terraform-root-module.md)
- [Resource-Validation-Report](../architecture/resource-validation-report.md) · TODO.md · [Deployment Runbook](../runbooks/deployment-runbook.md)
