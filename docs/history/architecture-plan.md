...
> deployment**, not a check that completes. Use [README.md](../repo/readme.md)
> for the current website and [TODO.md](../repo/todo.md) for pending engineering work.
>
...
> deliberately. Completion itself is recorded in [CHANGELOG.md](../repo/changelog.md);
> anything still open here says so in bold. This differs from
> [TODO.md](../repo/todo.md), which carries open work only and drops an item once its
...
> [CHANGELOG.md](../repo/changelog.md); the per-item evidence is Migration-Plan §3.1–3.5.
