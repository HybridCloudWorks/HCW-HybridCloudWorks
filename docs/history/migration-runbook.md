...
rehearsal uses a keyless account — live on [Phase-4-Data-Migration](../history/phase-4-data-migration.md).
The phase-level picture is [Migration-Plan](../history/migration-plan.md) §5.
...
[`scripts/set-github-variables.ps1`](https://github.com/HybridCloudWorks/HCW-HybridCloudWorks/blob/main/scripts/set-github-variables.ps1) wave 1.
