...
>   [ADR 0018](../decisions/0018-as-built-plan-v02.md), which superseded plan v0.1 with the
...
>   risk, not a pending action ([ADR 0021](../decisions/0021-key-vault-purge-protection.md)).
...
[Deployment Runbook](../runbooks/deployment-runbook.md#4-post-apply-verification) §4.*
